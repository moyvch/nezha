...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "font.terminalFontSizeHint": "Adjust the font size in terminal panels only. Range: 10–20px.",
    "font.uiFontFamily": "UI Font",
    "font.uiFontFamilyHint": "Font for interface text. Comma-separated for fallback.",
    "font.monoFontFamily": "Code Font",
    "font.monoFontFamilyHint": "Font for terminal, code blocks, and file viewer.",
  ...
  zh: {
    ...
    "font.terminalFontSizeHint": "仅调整终端面板中的字体大小，范围：10–20px。",
    "font.uiFontFamily": "UI 字体",
    "font.uiFontFamilyHint": "界面文本使用的字体，多个字体用逗号分隔作为回退。",
    "font.monoFontFamily": "代码字体",
    "font.monoFontFamilyHint": "终端、代码块和文件查看器使用的字体。",
    "font.preview": "预览",
    "common.reset": "重置",
    "language.english": "English",
    "language.chinese": "中文",
